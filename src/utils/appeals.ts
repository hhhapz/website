const location = typeof window !== "undefined" ? window.location : { protocol: "http", hostname: "theprogrammershangout.com" };
const baseURL = `${location.protocol}//${location.hostname}:4000`
